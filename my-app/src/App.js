...
export default function App() {
  return (
    <div>
      ...
      />
        <MainContent
        img="australia-pic.jpg"
        country="Australia"
        title="Bridge"
        date="1st Feb, 2021 -- 29th Feb, 2021"
      ...
      />
        ...
        country="Canada"
        title="Hills & Lake"
        date="1st March, 2021 -- 30th March, 2021"
        summary="It is the second largest country in the world, but it has only one-half of one percent of the world's population. Canada features black-blue lakes, numerous rivers, majestic western mountains, rolling central plains, and forested eastern valleys."
      />
    </div >
